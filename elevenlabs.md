...
Agent name: My Agent
Agent ID: agent_5101kthfh10gex5vkdmdjh6h5b0q
...
function Agent() {
  ...
  const startConversation = async () => {
    ...
    await conversation.startSession({
      agentId: "agent_5101kthfh10gex5vkdmdjh6h5b0q",
...
function ConversationScreen() {
  ...
  const start = async () => {
    await conversation.startSession({ agentId: "agent_5101kthfh10gex5vkdmdjh6h5b0q" });
  };
...
function App() {
  return <elevenlabs-convai agent-id="agent_5101kthfh10gex5vkdmdjh6h5b0q"></elevenlabs-convai>;
}

Or use the CDN directly in HTML:

<script src="https://elevenlabs.io/convai-widget/index.js" async></script>
<elevenlabs-convai agent-id="agent_5101kthfh10gex5vkdmdjh6h5b0q"></elevenlabs-convai>
...
conversation = Conversation(
    client,
    agent_id="agent_5101kthfh10gex5vkdmdjh6h5b0q",
    requires_auth=False,
...
Endpoint: wss://api.elevenlabs.io/v1/convai/conversation?agent_id=agent_5101kthfh10gex5vkdmdjh6h5b0q

const ws = new WebSocket(
  "wss://api.elevenlabs.io/v1/convai/conversation?agent_id=agent_5101kthfh10gex5vkdmdjh6h5b0q"
);
...
const response = await fetch(
  `https://api.elevenlabs.io/v1/convai/conversation/token?agent_id=agent_5101kthfh10gex5vkdmdjh6h5b0q`,
